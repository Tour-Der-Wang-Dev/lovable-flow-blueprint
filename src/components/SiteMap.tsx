...
import { ChevronRight, ChevronDown, Globe, Smartphone, Link2, Search, Lock, RefreshCw, Users, FileText } from 'lucide-react';
...
const SiteMapItemComponent: React.FC<ItemProps> = ({ item, level, isLast }) => {
...
export const SiteMap: React.FC<SiteMapProps> = ({ data }) => {
  return (
